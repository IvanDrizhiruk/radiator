...
public class StopWatchDemo {
	...
	public static void printElapsedTime(final int numberLoops,
		...
		} else
		{
			...
			out.println("\t" + stopwatch.elapsedMillis()
					+ " elapsed milliseconds.");
			out.println("\t" + stopwatch.elapsedTime(TimeUnit.MINUTES)
					+ " minutes");
			out.println("\t" + stopwatch.elapsedTime(TimeUnit.SECONDS)
					+ " seconds");
			out.println("\t" + stopwatch.elapsedTime(TimeUnit.MILLISECONDS)
					+ " milliseconds");
			out.println("\t" + stopwatch.elapsedTime(TimeUnit.NANOSECONDS)
					+ " nanoseconds");
		}
	}
