package ua.dp.ardas.radiator.jobs.thucydides.rest.test.result.r;
...
@Component
public class ThucydidesRestRTestStatisticContorller {
	private static Logger LOG = Logger.getLogger(ThucydidesRestRTestStatisticContorller.class.getName());
	
	@Autowired
	private ThucydidesTestRestClient restClient;
	@Autowired
	private ThucydidesRestTestStatisticDAO dao;
	@Value("${thucydides.rest.r.test.status.url}")
	private String url;
